						...
						<td align="right" valign="top">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: View Video <span  style="float:right; padding-right:10px;">

					                <input type="button" name="add" value="Add Video"  class="button" onclick="location.href='video-addf.php'" /></span>

								  </td>

								</tr>

								<form name="frm" method="post" action="video-del.php" enctype="multipart/form-data">
...
$sql=$obj->Query("select * from $tbl_video where 1=1 $where order by $order_by $order_by2 limit $start, $pagesize");

$sql2=$obj->query("select * from $tbl_video where 1=1 $where order by $order_by $order_by2",$debug=-1);
...
<td width="11%" align="center" bgcolor="#f3f4f6" class="padd5"><strong>Category</strong></td>
							  ...
							  while($resultlang=$obj->fetchNextObject($websiteLang)){
								  ...
								  $filed_name='town'.$resultlang->sort_name;

								  ?>

											<td width="16%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Video title(<?php echo $resultlang->language; ?>)</strong></td>
																...
																?>
																	...
																	<tr bgcolor="<?php echo $bgcolor;?>">
																		...
																		<td class="padd5"><strong><?php echo $i+$start; ?>.</strong></td>
																			<td class="padd5"><?php echo getField('title','tbl_video_category',$line->video_category)?></td>

                            <?php $websiteLang=$obj->query("select * from $tbl_websitelang order by id "); 

							  while($resultlang=$obj->fetchNextObject($websiteLang)){

								$filed_name='title'.$resultlang->sort_name;?>

							<td  class="padd5"><?php echo stripslashes($line->$filed_name); ?></td> 
                              ...
                              <?php } ?>
																    ...
																    <a href="video-addf.php?id=<?php echo $line->id;?>" ><img src="images/edit3.gif" border="0" title="Edit" /></a>
