	...
	function del_prompt(frmobj,comb)
		...
		//alert(comb);
			if(comb=='Delete'){
				...
				{
					frmobj.action = "additional-services-del.php";
						...
						<td align="right" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: View Services <span  style="float:right; padding-right:10px;">
					                <input type="button" name="add" value="Add Services"  class="button" onclick="location.href='additional-services-addf.php'" /></span>
								  </td>
								</tr>
								<form name="frm" method="post" action="additional-services-del.php" enctype="multipart/form-data">
									<tr>
...
$sql=$obj->Query("select * from $tbl_additional_services where 1=1 $where order by $order_by $order_by2 limit $start, $pagesize");
$sql2=$obj->query("select * from $tbl_additional_services where 1=1 $where order by $order_by $order_by2",$debug=-1);
$reccnt=$obj->numRows($sql2);
							  ...
							  while($resultlang=$obj->fetchNextObject($websiteLang)){
								  ...
								  ?>
											<td width="16%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Services(<?php echo $resultlang->language; ?>)</strong></td>
							...
							<td  class="padd5"><?php echo stripslashes($line->$filed_name); ?></td> 
                              <?php } ?>
																	  ...
																	  <?php if($line->status==1){?><img src="images/enable.gif" title="Activated" /><?php  } else{ ?><img src="images/disable.gif" title="Deactivated" /><?php }?>																					</td>
																		<td align="center" valign="middle" class="padd5">
																    <a href="additional-services-addf.php?id=<?php echo $line->id;?>" ><img src="images/edit3.gif" border="0" title="Edit" /></a>
                                                           </td>
																		<td align="center" valign="middle" class="padd5">
