						...
						<td align="right" valign="top">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: View Members <span  style="float:right; padding-right:10px;">
...
$sql=$obj->Query("select * from $tbl_member where 1=1 $where order by $order_by $order_by2 limit $start, $pagesize");

$sql2=$obj->query("select * from $tbl_member where 1=1 $where order by $order_by $order_by2",$debug=-1);
...
$reccnt=$obj->numRows($sql2);
                                       ...
                                       <td width="31%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Email</strong></td>
...
<!--<td width="16%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Target URL</strong></td> -->
							...
							<td  class="padd5"><?php echo stripslashes($line->FirstName); ?></td> 
	

						<td align="center" class="padd5"><?php echo stripslashes($line->About); ?>  </td>
						<td  class="padd5"><?php echo stripslashes($line->Email); ?></td>
												...
												<a href="viewmember-detail.php?id=<?php //echo $line->ID; ?>"  class="iframeenq" >View Detail</a></td>-->
