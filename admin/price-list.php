						...
						<td align="right" valign="top">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: View Membership Price <span  style="float:right; padding-right:10px;">

					                <input type="button" name="add" value="Add Price"  class="button" onclick="location.href='price-addf.php'" /></span>

								  </td>

								</tr>

								<form name="frm" method="post" action="price-del.php" enctype="multipart/form-data">
...
$sql=$obj->Query("select * from tbl_price where 1=1 $where order by $order_by $order_by2 limit $start, $pagesize");

$sql2=$obj->query("select * from tbl_price where 1=1 $where order by $order_by $order_by2",$debug=-1);
...
$reccnt=$obj->numRows($sql2);
                                             ...
                                             <?php $filed_name='category' ;

								  ?>

											<td width="16%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Membership Name</strong></td>
											<td width="16%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Price</strong></td>
                            ...
                            <?php $filed_name='membership_name';?>

							<td  class="padd5"><?php echo stripslashes($line->$filed_name); ?></td> 
							<td  class="padd5"><?php echo stripslashes($line->price); ?></td> 
																    ...
																    <a href="price-addf.php?id=<?php echo $line->id;?>" ><img src="images/edit3.gif" border="0" title="Edit" /></a>
