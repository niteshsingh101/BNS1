...
include("../include/simpleimage.php");
 ...
 validate_admin();
  ...
  if($_REQUEST['id']==''){
	  ...
	  $obj->query("insert into tbl_orientation set orientation='$orientation',status=1 ");

	  $_SESSION['sess_msg']='orientation added successfully';  

	  

       }else{ 

	   $sql=" update tbl_orientation set orientation='$orientation' ";

	   $sql.=" where id='".$_REQUEST['id']."'";

	   $obj->query($sql);

	   $_SESSION['sess_msg']='orientation updated sucessfully';   

        }

   header("location:orientation-list.php");
...
$sql=$obj->query("select * from tbl_orientation where id=".$_REQUEST['id']);
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="right" valign="top">
					...
					<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: <?php if($_REQUEST['id']==''){ ?>Add<?php }else{ ?>Update<?php }?> orientation<span  style="float:right; padding-right:10px;">

					<input type="button" name="add" value="View orientation"  class="button" onclick="location.href='orientation-list.php'" /></span></td>
							...
							<table width="100%" cellpadding="0" cellspacing="0">
							  ...
							  <?php $field_name='orientation';
								...
								<tr>
									  ...
									  <td align="right" class="paddRt14 paddBot11"><strong>orientation:</strong></td>
