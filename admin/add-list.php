						...
						<td align="right" valign="top">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: View Add <span  style="float:right; padding-right:10px;">
								...
								<form name="frm" method="post" action="add-del.php" enctype="multipart/form-data">
...
$sql=$obj->Query("select * from tbl_add where 1=1 $where order by $order_by $order_by2 limit $start, $pagesize");

$sql2=$obj->query("select * from tbl_add where 1=1 $where order by $order_by $order_by2",$debug=-1);
...
$reccnt=$obj->numRows($sql2);
										...
										<td width="24%" align="center" bgcolor="#f3f4f6" class="padd5"><strong>Location</strong></td>
                                       <td width="31%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Category</strong></td>
...
<!--<td width="16%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Target URL</strong></td> -->
															    <td width="7%" align="center" bgcolor="#f3f4f6" class="padd5"><strong>Status</strong></td>
																	...
																	<td width="6%" align="center" class="padd5" bgcolor="#f3f4f6"><strong>Details</strong></td> 
						...
						<td align="center" class="padd5"><?php echo stripslashes($line->location); ?>  </td>
						<td  class="padd5"><?php echo stripslashes($line->membership_name); ?></td>
												...
												<a href="viewadd-detail.php?id=<?php echo $line->ID; ?>"  class="iframeenq" >View Detail</a></td>
