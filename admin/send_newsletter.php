...
<tr>
  ...
  <tr>
    <td>
    <form name="searchForm" method="post" action="send_newsletter.php">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
  
    <td width="10%" align="right" bgcolor="#f3f4f6"  class="" ><strong>Email:</strong></td>
    ...
    <td width="12%"><a href="send_newsletter.php">View All</a></td>
  </tr>
</table>
</form>
</td>
								...
								<tr>
									...
									<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: View Subscribers</td>
								</tr>
                            ...
                            <tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td  class="padd5" style="padding-left:20px;"><strong>Select Template</strong></td>
  </tr>
  <tr><td height="10"></td></tr>
  <tr>
    <td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="23%" align="right" bgcolor="#f3f4f6"  class="" ><strong>Select Template:</strong></td>
    <td width="77%"><select name="news_temp" style="width:240px;">
...
$reccnt=$obj->numRows($sql2);
															...
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	...
																	<td width="6%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Email</strong></td>
