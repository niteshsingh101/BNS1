...
if(count($arr)>0){
...

	{
	    ...
	    $sql="delete from $tbl_hair_color where id in ($str_rest_refs)"; 
	...
	{	
		...
		$sql="update $tbl_hair_color set status=1 where id in ($str_rest_refs)";
	...
	{		
		 ...
		 $sql="update $tbl_hair_color set status=0 where id in ($str_rest_refs)";
