...
include("../include/simpleimage.php");
 ...
 validate_admin();
  ...
  if($_REQUEST['id']==''){
	  ...
	  $obj->query("insert into tbl_occupation set occupation='$occupation',status=1 ");
	  ...
	  $_SESSION['sess_msg']='Services added successfully';  
	   ...
	   $sql=" update $tbl_occupation set occupation='$occupation'";
   ...
   header("location:occupation-list.php");
...
$sql=$obj->query("select * from $tbl_occupation where id=".$_REQUEST['id']);
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="right" valign="top">
					...
					<input type="button" name="add" value="View Services"  class="button" onclick="location.href='occupation-list.php'" /></span></td>
							...
							<table width="100%" cellpadding="0" cellspacing="0">
							  ...
							  <?php $field_name='occupation';
								...
								<tr>
									  ...
									  <td align="right" class="paddRt14 paddBot11"><strong>Services:</strong></td>
