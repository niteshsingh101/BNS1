...
include("../include/simpleimage.php");
 ...
 validate_admin();
  ...
  if($_REQUEST['id']==''){
	  ...
	  $obj->query("insert into tbl_video_category set title='$title',title_ge='$title_ge',title_sp='$title_sp',title_fr='$title_fr',title_po='$title_po',description='$description',description_ge='$description_ge',description_sp='$description_sp',description_fr='$description_fr',description_po='$description_po',status=1 ");
	  ...
	  $_SESSION['sess_msg']='Video added successfully';  
	   ...
	   $sql=" update $tbl_video_category set title='$title',title_ge='$title_ge',title_sp='$title_sp',title_fr='$title_fr',title_po='$title_po',description_ge='$description_ge',description_sp='$description_sp',description_fr='$description_fr',description_po='$description_po' ";
   ...
   header("location:video-category-list.php");
...
$sql=$obj->query("select * from $tbl_video_category where id=".$_REQUEST['id']);
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="right" valign="top">
					...
					<input type="button" name="add" value="View Video"  class="button" onclick="location.href='video-category-list.php'" /></span></td>
						...
						<input type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>" />
							...
							<table width="100%" cellpadding="0" cellspacing="0">
							  ...
							  while($resultlang=$obj->fetchNextObject($websiteLang)){
								  ...
								  $field_name1='description'.$resultlang->sort_name;
								...
								<tr>
									  ...
									  <td align="right" class="paddRt14 paddBot11"><strong>Video Category title(<?php echo $resultlang->language; ?>):</strong></td>
							    ...
							    <tr>
                                      ...
                                      <textarea name="<?php echo $field_name1; ?>"  rows="7" cols="30"  value="<?php echo stripslashes($result->$field_name1);?>" ></textarea>
