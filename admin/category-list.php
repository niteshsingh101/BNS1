						...
						<td align="right" valign="top">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
					                ...
					                <input type="button" name="add" value="Add Category"  class="button" onclick="location.href='category-addf.php'" /></span>
...
$reccnt=$obj->numRows($sql2);
							...
							<td  class="padd5"><?php echo stripslashes($line->$filed_name); ?></td> 
																    ...
																    <a href="category-addf.php?id=<?php echo $line->id;?>" ><img src="images/edit3.gif" border="0" title="Edit" /></a>
