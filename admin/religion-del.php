...
if(count($arr)>0){
...

	{
	    ...
	    $sql="delete from $tbl_religion where id in ($str_rest_refs)"; 
	...
	{	
		...
		$sql="update $tbl_religion set status=1 where id in ($str_rest_refs)";
	...
	{		
		 ...
		 $sql="update $tbl_religion set status=0 where id in ($str_rest_refs)";
