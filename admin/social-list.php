						...
						<td align="right" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: View Social Network URL</td>
								</tr>
...
$sql=$obj->Query("select * from $tbl_social where 1=1 $where order by $order_by $order_by2 limit $start, $pagesize");
$sql2=$obj->query("select * from $tbl_social where 1=1 $where order by $order_by $order_by2",$debug=-1);
$reccnt=$obj->numRows($sql2);
															...
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	<td width="8%" align="left" class="padd5" bgcolor="#f3f4f6"><strong>S No.</strong></td>
                                                                    <td width="28%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Title</strong></td>
																	<td width="28%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>URL</strong></td>
																...
																?>
																	<tr bgcolor="<?php echo $bgcolor;?>">
																		...
																		<td class="padd5">
																		<?php
																		echo stripslashes($line->social_url);
																		?>																		</td>
																	...
																	<!--	<td valign="top" class="padd5">
																		...
																		<a href="social-addf.php?id=<?php echo $line->id;?>" ><img src="images/edit3.gif" border="0" title="Edit" /></a><br/>
																...
																?>
													<tr>
                          <td valign="top" colspan="6"  align="right">&nbsp;</td>   </tr>    			
	<tr>
                          <td valign="top" colspan="6"  align="right" class="dark_red" style="padding-right:150px;"><?php include("../include/paging.inc.php"); ?></td>   </tr>    			
	<tr>
	  <td align="right"  style="padding-right:80px;" colspan="6">&nbsp;</td>
	  </tr>
	<tr>
	  <td align="right"  style="padding-right:80px;" colspan="6">&nbsp;</td>
	  </tr>
	<!--<tr><td align="right"  style="padding-right:80px;" colspan="6"> <input type="hidden" name="what" value="what" />
