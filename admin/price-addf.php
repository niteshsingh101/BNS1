...
include("../include/simpleimage.php");
 ...
 validate_admin();
  ...
  if($_REQUEST['id']==''){
	  ...
	  $obj->query("insert into tbl_price set membership_name='$membership_name',price='$price',status=1 ");

	  $_SESSION['sess_msg']='Price added successfully';  

	  

       }else{ 

	   $sql=" update tbl_price set membership_name='$membership_name',price='$price' ";

	   $sql.=" where id='".$_REQUEST['id']."'";

	   $obj->query($sql);

	   $_SESSION['sess_msg']='Price updated sucessfully';   
...
$sql=$obj->query("select * from tbl_price where id=".$_REQUEST['id']);
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="right" valign="top">
					...
					<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: <?php if($_REQUEST['id']==''){ ?>Add<?php }else{ ?>Update<?php }?> Price<span  style="float:right; padding-right:10px;">

					<input type="button" name="add" value="View Price"  class="button" onclick="location.href='price-list.php'" /></span></td>
						...
						<input type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>" />
							...
							<table width="100%" cellpadding="0" cellspacing="0">
							  ...
							  <?php $field_name='membership_name';
								...
								<tr>
									  ...
									  <td align="right" class="paddRt14 paddBot11"><strong>Membership Name:</strong></td>
                                      ...
                                      <input name="price"  size="36"  value="<?php echo stripslashes($result->price);?>" >
