						...
						<td align="right" valign="top">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: View Banners <span  style="float:right; padding-right:10px;">

					                <input type="button" name="add" value="Add Banner"  class="button" onclick="location.href='banner-addf.php'" /></span>
...
$sql=$obj->Query("select * from $tbl_banner where 1=1 $where order by $order_by $order_by2 limit $start, $pagesize");

$sql2=$obj->query("select * from $tbl_banner where 1=1 $where order by $order_by $order_by2",$debug=-1);
...
$reccnt=$obj->numRows($sql2);
										...
										<td width="24%" align="center" bgcolor="#f3f4f6" class="padd5"><strong>Banner Image</strong></td>
...
<!--<td width="16%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Target URL</strong></td> -->
						...
						<td align="center" class="padd5"><?php if(is_file("../upload_images/banner/thumb/".$line->photo)){?><img src="../upload_images/banner/thumb/<?php echo  $line->photo;?>" width="120" height="60"  /><?php } ?>
                        </td>
<td  class="padd5"><?php echo substr(stripslashes($line->description),0,300).".."; ?></td>
																    ...
																    <a href="banner-addf.php?id=<?php echo $line->id;?>" ><img src="images/edit3.gif" border="0" title="Edit" /></a></td>
