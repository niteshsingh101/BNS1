...
include("../include/simpleimage.php");
 validate_admin();
  ...
  if($_REQUEST['id']==''){
	  $obj->query("insert into $tbl_banner set title='$title',title_ge='$title_ge',title_sp='$title_sp',title_fr='$title_fr',title_po='$title_po',description='$description',description_ge='$description_ge',description_sp='$description_sp',description_fr='$description_fr',description_po='$description_po',target_url='$target_url',photo='$img',status=1 ");
	  $_SESSION['sess_msg']='Banner added sucessfully';  
	  
       }else{ 
	   $sql=" update $tbl_banner set title='$title',title_ge='$title_ge',title_sp='$title_sp',title_fr='$title_fr',title_po='$title_po',description='$description',description_ge='$description_ge',description_sp='$description_sp',description_fr='$description_fr',description_po='$description_po',target_url='$target_url' ";
	   if($img){
...
<?php } ?>
 ...
 while($resultlang=$obj->fetchNextObject($websiteLang)){
	 ...
	 $field3='target_url'.$resultlang->sort_name;
     ?>                       
