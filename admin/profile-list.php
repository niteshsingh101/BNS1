...
<script>
			...
			$(document).ready(function(){
				    ...
				    $(".iframeenq").colorbox({iframe:true, width:"850px;", height:"600px;", frameborder:"0",scrolling:true});
						...
						<td align="right" valign="top">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: View Profiles <span  style="float:right; padding-right:10px;">



					                <input type="button" name="add" value="Add Profile"  class="button" onclick="location.href='profile-addf.php'" /></span>
								...
								<form name="frm" method="post" action="profile-del.php" enctype="multipart/form-data">
...
$sql=$obj->Query("select * from $tbl_profile where 1=1 $where order by $order_by $order_by2 limit $start, $pagesize");



$sql2=$obj->query("select * from $tbl_profile where 1=1 $where order by $order_by $order_by2",$debug=-1);
...
$reccnt=$obj->numRows($sql2);
											...
											<td width="20%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Name</strong></td>					

										<td width="24%" align="center" bgcolor="#f3f4f6" class="padd5"><strong>About</strong></td>

                                       <td width="31%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Marital status</strong></td>
<!--
									   <td width="31%" align="center" bgcolor="#f3f4f6" class="padd5"><strong>Manage Images</strong></td>
-->
<!--<td width="16%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Target URL</strong></td> -->
						...
						<td align="center" class="padd5"><?php echo stripslashes($line->description); ?>  </td>

						<td  class="padd5"><?php echo stripslashes($line->Maritalstatus); ?></td>

																																																		

                                                                 <!--<td align="center" valign="middle" class="padd5">

                                       <a href="addprofileImages.php?profile_id=<?php //echo $line->ID; ?>" class="iframeenq"><strong>Manage Gallery</strong></a>
																    ...
																    <a href="profile-addf.php?id=<?php echo $line->ID;?>" ><img src="images/edit3.gif" border="0" title="Edit" /></a></td>
