...
if(count($arr)>0){
...

	{
	    ...
	    $sql="delete from $tbl_eyes_color where id in ($str_rest_refs)"; 
	...
	{	
		...
		$sql="update $tbl_eyes_color set status=1 where id in ($str_rest_refs)";
	...
	{		
		 ...
		 $sql="update $tbl_eyes_color set status=0 where id in ($str_rest_refs)";
