...
<tr>
  ...
  <tr>
    <td>
    <form name="searchForm" method="post" action="enquiry-list.php">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="12%"><a href="enquiry-list.php">View All</a></td>
								...
								<tr>
									...
									<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: View Enquiries</td>
								</tr>
...
$where.=" and uemail like '%$name%' ";	
}
if($_REQUEST['search_mobile']!=''){
$name=$_REQUEST['search_mobile']	;
$where.=" and contact like '%$name%' ";	
}
$start=0;
...
$reccnt=$obj->numRows($sql2);
	                                                  ...
	                                                  <td valign="top" colspan="11"  align="center" class="dark_red" ><strong><?php echo $reccnt;?> Record found.</strong></td>
																...
																?>
																	<tr bgcolor="<?php echo $bgcolor;?>">
                                                                        ...
                                                                        <td class="padd5">
																		<?php
																			echo date('d M Y H:i',strtotime($line->send_date));
																		?>
																		</td>
																		...
																		?>
                                                                         ...
                                                                         <td class="padd5">
																		<?php echo substr(stripslashes($line->enq_message),0,200); ?>
																		</td>
																			<script>
			...
			$(document).ready(function(){
				    $(".iframeenq<?php echo $line->id; ?>").colorbox({iframe:true, width:"800px;", height:"600px;", frameborder:"0",scrolling:true});
                                                                         ...
                                                                         <td class="padd5">
											 <a href="viewenquiry-detail.php?id=<?php echo $line->id; ?>"  class="iframeenq<?php echo $line->id; ?>" >View Detail</a>
																		</td>
