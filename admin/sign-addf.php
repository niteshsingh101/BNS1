...
include("../include/simpleimage.php");
 ...
 validate_admin();
  ...
  if($_REQUEST['id']==''){
	  ...
	  $obj->query("insert into tbl_sign set sign='$sign',sign_ge='$sign_ge',sign_sp='$sign_sp',sign_fr='$sign_fr',sign_po='$sign_po',status=1 ");

	  $_SESSION['sess_msg']='Sign added successfully';  

	  

       }else{ 

	   $sql=" update $tbl_sign set sign='$sign',sign_ge='$sign_ge',sign_sp='$sign_sp',sign_fr='$sign_fr',sign_po='$sign_po' ";

	   $sql.=" where id='".$_REQUEST['id']."'";

	   $obj->query($sql);

	   $_SESSION['sess_msg']='Sign updated sucessfully';   

        }

   header("location:sign-list.php");
...
$sql=$obj->query("select * from $tbl_sign where id=".$_REQUEST['id']);
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="right" valign="top">
					...
					<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: <?php if($_REQUEST['id']==''){ ?>Add<?php }else{ ?>Update<?php }?> Sign<span  style="float:right; padding-right:10px;">

					<input type="button" name="add" value="View Sign"  class="button" onclick="location.href='sign-list.php'" /></span></td>
						...
						<input type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>" />
							...
							<table width="100%" cellpadding="0" cellspacing="0">
							  ...
							  while($resultlang=$obj->fetchNextObject($websiteLang)){
								  ...
								  $field_name='sign'.$resultlang->sort_name;
								...
								<tr>
									  ...
									  <td align="right" class="paddRt14 paddBot11"><strong>Sign(<?php echo $resultlang->language; ?>):</strong></td>
