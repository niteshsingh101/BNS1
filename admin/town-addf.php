...
include("../include/simpleimage.php");
 ...
 validate_admin();
  ...
  if($_REQUEST['id']==''){
	  ...
	  $obj->query("insert into tbl_town set town='$town',CountryName='$CountryName',state='$state',status=1 ");
	  ...
	  $_SESSION['sess_msg']='Town added successfully';  
	   ...
	   $sql=" update $tbl_town set town='$town',CountryName='$CountryName',state='$state' ";
...
$sql=$obj->query("select * from $tbl_town where id=".$_REQUEST['id']);
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="right" valign="top">
					...
					<input type="button" name="add" value="View Town"  class="button" onclick="location.href='town-list.php'" /></span></td>
