		...
		//alert(comb);
			...
			if(comb=='Delete'){
...

				{
					...
					frmobj.action = "video-category-del.php";
						...
						<td align="right" valign="top">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
					                ...
					                <input type="button" name="add" value="Add Video Category"  class="button" onclick="location.href='video-category-addf.php'" /></span>
...
$sql=$obj->Query("select * from $tbl_video_category where 1=1 $where order by $order_by $order_by2 limit $start, $pagesize");

$sql2=$obj->query("select * from $tbl_video_category where 1=1 $where order by $order_by $order_by2",$debug=-1);
...
$reccnt=$obj->numRows($sql2);
							  ...
							  while($resultlang=$obj->fetchNextObject($websiteLang)){
								  ...
								  ?>
											...
											<td width="16%" align="left" bgcolor="#f3f4f6" class="padd5"><strong>Video Category title(<?php echo $resultlang->language; ?>)</strong></td>
							...
							<td  class="padd5"><?php echo stripslashes($line->$filed_name); ?></td> 
                              ...
                              <?php } ?>
																    ...
																    <a href="video-category-addf.php?id=<?php echo $line->id;?>" ><img src="images/edit3.gif" border="0" title="Edit" /></a>
