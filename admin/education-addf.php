...
include("../include/simpleimage.php");
 ...
 validate_admin();
  ...
  if($_REQUEST['id']==''){
	  ...
	  $obj->query("insert into tbl_category set category='$category',status=1 ");

	  $_SESSION['sess_msg']='Category added successfully';  

	  

       }else{ 

	   $sql=" update tbl_category set category='$category' ";
...
$sql=$obj->query("select * from tbl_category where id=".$_REQUEST['id']);
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="right" valign="top">
					...
					<em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: <?php if($_REQUEST['id']==''){ ?>Add<?php }else{ ?>Update<?php }?> Category<span  style="float:right; padding-right:10px;">

					<input type="button" name="add" value="View Category"  class="button" onclick="location.href='education-list.php'" /></span></td>
							...
							<table width="100%" cellpadding="0" cellspacing="0">
							  ...
							  <?php $field_name='category';
								...
								<tr>
									  ...
									  <td align="right" class="paddRt14 paddBot11"><strong>Category:</strong></td>
